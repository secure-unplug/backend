...
from .views import save_entries, view_entries, view_average_money, view_device_data, view_average_kwatt, get_kwatt_level, view_period_average, view_device_fee, view_my_entries, view_my_entries
urlpatterns = [
